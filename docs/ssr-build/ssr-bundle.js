...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_preact__ = __webpack_require__("KM04");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_preact___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_preact__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__components_KtpField__ = __webpack_require__("ZwNj");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__components_UserCard__ = __webpack_require__("6ATj");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__components_KtpResult__ = __webpack_require__("K+dO");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__components_Modal__ = __webpack_require__("TDbV");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__components_ButtonFab__ = __webpack_require__("crmn");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6_mobx_react__ = __webpack_require__("/nBs");
...
var Home = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_6_mobx_react__["observer"])(_class = function (_Component) {
  ...
  Home.prototype.submitNewKtp = function submitNewKtp(value) {
    // add new KTP
  ...
  Home.prototype.deleteKtp = function deleteKtp(value) {
    this.props.store.deleteKtp(value);
  };

  Home.prototype.updateKtp = function updateKtp(value) {
    var urut = this.props.store.KTPS.findIndex(function (i) {
      return i._idx === value;
    });
    this.setState({
  ...
  Home.prototype.render = function render() {
    ...
    var KTPS = this.props.store.KTPS;


    var renderCard = KTPS.slice().map(function (ktp) {
      return __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0_preact__["h"])(
        'div',
        { key: ktp._idx },
        __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0_preact__["h"])(__WEBPACK_IMPORTED_MODULE_2__components_UserCard__["a" /* default */], { fullName: ktp.ktpData.fullName, nik: ktp.ktpData.nik, gender: ktp.ktpData.gender })
      );
    });
    var renderResult = KTPS.slice().map(function (ktp) {
      return __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0_preact__["h"])(
        'div',
        { key: ktp._idx },
        __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0_preact__["h"])(__WEBPACK_IMPORTED_MODULE_3__components_KtpResult__["a" /* default */], { dataKTP: ktp.ktpData, index: ktp._idx, editButton: _this2.updateKtp.bind(_this2), removeButton: _this2.deleteKtp.bind(_this2) })
      );
    });
    ...
    return __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0_preact__["h"])(
      ...
      __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0_preact__["h"])(
        ...
        __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0_preact__["h"])(
          ...
          __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0_preact__["h"])(
            'div',
            { style: Style.addActionContainer },
            __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0_preact__["h"])(
              __WEBPACK_IMPORTED_MODULE_5__components_ButtonFab__["a" /* default */],
              null,
              __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0_preact__["h"])(
                'i',
                { className: 'material-icons', onClick: this.modalOpen.bind(this) },
                'add'
              )
            )
          )
      ...
      __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0_preact__["h"])(
        ...
        __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0_preact__["h"])(
          ...
          __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0_preact__["h"])(__WEBPACK_IMPORTED_MODULE_1__components_KtpField__["a" /* default */], { Submit: this.submitNewKtp.bind(this), cancelInput: this.modalClose.bind(this), defaultData: this.state.defaultKtp })
        )
      )
    );
  };
...
/* harmony default export */ __webpack_exports__["default"] = (__WEBPACK_IMPORTED_MODULE_2__components_app__["a" /* default */]);
		...
		__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0_preact__["h"])(
			...
			__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0_preact__["h"])(
				...
				{ href: '#', onClick: function onClick() {
						return props.removeButton(props.index);
					} },
				_ref2
			),
			__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0_preact__["h"])(
				'a',
				{ href: '#', onClick: function onClick() {
						return props.editButton(props.index);
					} },
				_ref3
			)
		)
...
var addID = function addID(obj, key, val) {
  var newObj = _extends({}, obj);
  newObj[key] = val;
  return newObj;
};

var KTP = (_class = function KTP(value) {
  _classCallCheck(this, KTP);

  _initDefineProp(this, '_idx', _descriptor, this);

  _initDefineProp(this, 'ktpData', _descriptor2, this);

  this._idx = Date.now();
  this.ktpData = addID(value, '_index', this._idx);
}, (_descriptor = _applyDecoratedDescriptor(_class.prototype, '_idx', [__WEBPACK_IMPORTED_MODULE_0_mobx__["observable"]], {
  enumerable: true,
  initializer: null
}), _descriptor2 = _applyDecoratedDescriptor(_class.prototype, 'ktpData', [__WEBPACK_IMPORTED_MODULE_0_mobx__["observable"]], {
  enumerable: true,
  initializer: null
})), _class);
var KtpStore = (_class3 = function () {
  function KtpStore() {
    ...
    _initDefineProp(this, 'KTPS', _descriptor3, this);
  }
  ...
  KtpStore.prototype.updateKtp = function updateKtp(value) {
    var urut = this.KTPS.findIndex(function (i) {
      return i._idx === value._index;
    });
  ...
  KtpStore.prototype.deleteKtp = function deleteKtp(value) {
    var urut = this.KTPS.findIndex(function (i) {
      return i._idx === value;
    });
  ...
  return KtpStore;
}(), (_descriptor3 = _applyDecoratedDescriptor(_class3.prototype, 'KTPS', [__WEBPACK_IMPORTED_MODULE_0_mobx__["observable"]], {
  enumerable: true,
...
var KtpField = function (_Component) {
  ...
  function KtpField(props) {
    ...
    _this.state = {
      _index: _this.props.defaultData._index,
  ...
  KtpField.prototype.handleSave = function handleSave(e) {
    ...
    var dataKTP = {
      ...
      //  Export state to Parent Components as Object when press Submit
    };this.props.Submit(dataKTP);

    // Reset State to initial Value
    this.setState({
      _index: this.props.defaultData._index,
  ...
  KtpField.prototype.componentWillReceiveProps = function componentWillReceiveProps(newProps) {
    this.setState({
      _index: newProps.defaultData._index,
      _id: newProps.defaultData._id,
      nik: newProps.defaultData.nik,
      fullName: newProps.defaultData.fullName,
      bornPlace: newProps.defaultData.bornPlace,
      bornDay: newProps.defaultData.bornDay,
      bornMonth: newProps.defaultData.bornMonth,
      bornYear: newProps.defaultData.bornYear,
      gender: newProps.defaultData.gender,
      streetAddress: newProps.defaultData.streetAddress,
      rt: newProps.defaultData.rt,
      rw: newProps.defaultData.rw,
      kelurahanType: newProps.defaultData.kelurahanType,
      kelurahanName: newProps.defaultData.kelurahanName,
      kecamatan: newProps.defaultData.kecamatan,
      cityType: newProps.defaultData.cityType,
      cityName: newProps.defaultData.cityName,
      martialStatus: newProps.defaultData.martialStatus,
      occupation: newProps.defaultData.occupation
    });
  };
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__stores_store__ = __webpack_require__("Kh7d");
...
var _ref = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0_preact__["h"])(
	...
	__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0_preact__["h"])(__WEBPACK_IMPORTED_MODULE_2__routes_home__["a" /* default */], { store: __WEBPACK_IMPORTED_MODULE_3__stores_store__["a" /* default */] })
);
